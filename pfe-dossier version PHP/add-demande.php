...
<body>
    <header>
        ...
        <nav>
            <li><a href="ppageparlogin.php">Accueil</a></li>
     ...
     <center><article>
        ...
        <div class="form">
            <form action="">
                ...
                <section>
                    <div class="inputdemande"><textarea name="message" placeholder="ecrivez votre demande" id="" ></textarea></div>
                    <div class="inputimage"><label for="file">Sélectionner une photo de problem</label> </div>
