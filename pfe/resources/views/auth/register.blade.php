...
<head>
    ...
    <link rel="stylesheet" href="css/styleregistre.css">
</head>
<body>
    <div class="container">
            ...
            <div class="card" >
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="location" class="col-md-4 col-form-label text-md-end">{{ __('Adresse') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" accept="image/*" required autocomplete="image" autofocus>
