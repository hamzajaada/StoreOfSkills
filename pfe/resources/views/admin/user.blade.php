...
<body>
    <div id="app">
        ...
        @if(session('error'))
            <div class="alert alert-danger my-4" style="position: absolute; margin-top: -2.5rem!important; margin-left: 24%; width: 65%;">
                {{ session('error') }}
            </div>
        @endif
        @if (session('success'))
            <div class="alert alert-success" style="position: absolute; margin-top: -2.5rem!important; margin-left: 24%; width: 65%;">
                {{ session('success') }}
            </div>
        @endif
