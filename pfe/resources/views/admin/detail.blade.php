...
<div id="app">
    ...
    <section class="AF" >
        ...
        <form style="border-radius: 7px" class="row g-3" method="post" action="" enctype="multipart/form-data">
            ...
            {{-- @method('PUT') --}}
            <center>
                <div class="info-per" style="display:flex;justify-content: space-evenly;width: 80%;">
                    <div class="img-prfl"><img src="{{asset('image/'.$offre->image)}}" style="width: 100px;height: 100px;border-radius: 50%"></div>
                    <h2 class="info-prfil" style="margin-left: 25px;font-family: 'Open Sans', sans-serif;font-size: 3.3em;font-weight: 600;color: #333333;">{{ $offre->nom }} {{ $offre->prenom }}</h2>
                </div>
                <br>
