...
Route::get('home/users/delete',[UserController::class,'delete_user'])->name('users.user.delete');
Route::get('home/offres/delete',[UserController::class,'delete_offre'])->name('users.offre.delete');
